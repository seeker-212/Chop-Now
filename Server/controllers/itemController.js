...
//---------- This controller will delete Items ---------
...
//---------- This controller will get Item By City ----------
...
export const rating = async (req, res) => {
  try {
    ...
    if (!itemId || !rating) {
      return res.status(400).json({ message: "ItemId and rating not found" });
    }
