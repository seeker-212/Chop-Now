    ...
    <div className="w-screen min-h-screen flex flex-col gap-5 items-center bg-[#fff9f6] overflow-y-auto">
      ...
      {myShopData && (
        <div className="w-full flex flex-col items-center gap-6 px-4 sm:px-6">
          ...
          <div
            className="bg-white shadow-lg rounded-xl overflow-hidden border border-green-100
          hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative"
          >
            <div
              className="absolute top-4 right-4 bg-[#32CD32] text-white p-2 rounded-full shadow-md
